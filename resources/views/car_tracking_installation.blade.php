...
<head>
  ...
  <title>Become a car tracker installer </title>
...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="hero d-flex align-items-center" style="background:">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="assets_2/img/3.png" class="img-fluid" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="assets_2/img/10.jpg" style="margin:10px auto; height:400px" class="img-fluid" alt="">
          </div>
    ...
    <section id="features" class="features">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <img src="assets_2/img/11.jpg" style="margin-left:20px; height:400px" class="img-fluid" alt="">
          </div>
          ...
          <div class="col-lg-6 mt-5 mt-lg-0 d-flex">
            <div class="row align-self-center gy-4">
              ...
              <div class="col-md-6" data-aos="zoom-out" data-aos-delay="400">
                <div class="feature-box d-flex align-items-center">
                  <i class="bi bi-check"></i>
                  <h3> Readiness to implement what you've learnt</h3>
                </div>
              </div>
              ...
              <div class="col-md-6" data-aos="zoom-out" data-aos-delay="500">
                <div class="feature-box d-flex align-items-center">
                  <i class="bi bi-check"></i>
                  <h3>A strong desire to gain financial freedom</h3>
                </div>
              </div>
              ...
              <div class="col-md-6" data-aos="zoom-out" data-aos-delay="600">
                <div class="feature-box d-flex align-items-center">
                  <i class="bi bi-check"></i>
                  <h3>Minimum of 2 hours to work per week!</h3>
                </div>
              </div>
              ...
              <div class="col-md-6" data-aos="zoom-out" data-aos-delay="700">
                <div class="feature-box d-flex align-items-center">
                  <i class="bi bi-check"></i>
                  <h3>Aspiration to become your own boss</h3>
                </div>
              </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-box blue">
              ...
              <p>Step-by-step guide to installing Car tracker , even if you’re still a beginner.</p>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-box orange">
              <i class="ri-discuss-line icon"></i>
              <h3>Monetization</h3>
              <p>You will discover the special way to price your services and make your clients happily pay you without much back and forth.</p>
              <a href="<?php echo $whatsapp;?>" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-box green">
              <i class="ri-discuss-line icon"></i>
              <h3>Positioning</h3>
              <p>You will discover how to position yourself as an expert. So you attract customers, and make them come back for your services. Instead of running after them- This is a business secret you will hardly learn anywhere.</p>
              <a href="<?php echo $whatsapp;?>" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-box red">
              <i class="ri-discuss-line icon"></i>
              <h3>Activation procedures</h3>
              <p>The secret method to easily activate the tracker for your clients by simply sending SMS commands.</p>
              <a href="<?php echo $whatsapp;?>" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-box purple">
              <i class="ri-discuss-line icon"></i>
              <h3>Tools of the skill.</h3>
              <p>They are easily sourced tools. In this module you will learn the uses of these tools and how to efficiently use them to save time.</p>
              <a href="<?php echo $whatsapp;?>" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="700">
            <div class="service-box pink">
              ...
              <p>The easiest way to get a license and become a licensed car tracker installer- This allows you to work with government agencies and high-profile personnel.</p>
              <a href="<?php echo $whatsapp;?>" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
